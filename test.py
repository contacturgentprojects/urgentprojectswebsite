...
with tab1:
    ...
    """)
    st.markdown('<a href="https://wa.link/w0u0yn" target="_blank"><button style="padding: 10px 20px; font-size: 16px; color: white; background-color: #008000; border: none; border-radius: 5px;">Contact Us</button></a>', unsafe_allow_html=True)
